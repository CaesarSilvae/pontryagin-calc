...
│    └── toLog.m          # Log keeper
├── data_D4to32.zip   # Zip folder containing data generated for D=4 to D=32 dimension
...
|      | 2/3        | 1                          |                              |                                                  |                            |
| $6$ | $\omega^5$ | $(\text{d}\omega)\omega^3$ | $(\text{d}\omega)^2\omega$   |                                                  |                            |
|      | 3/5        | 3/2                        | 1                            |                                                  |                            |
| $8$ | $\omega^7$ | $(\text{d}\omega)\omega^7$ | $(\text{d}\omega)^2\omega^3$ | $(\text{d}\omega)\omega(\text{d}\omega)\omega^2$ | $(\text{d}\omega)^3\omega$ |
|      | 4/7        | 2                          | 8/5                          | 4/5                                              | 1                          |
